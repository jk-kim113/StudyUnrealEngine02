...
void AFountain::BeginPlay()
{
	...
	//UE_LOG(ArenaBattle, Warning, TEXT("Actor Name : %s, ID : %d, Locatin X : %.3f"), *GetName(), ID, GetActorLocation().X);

	ABLOG_S(Warning);
	ABLOG(Warning, TEXT("Actor Name : %s, ID : %d, Locatin X : %.3f"), *GetName(), ID, GetActorLocation().X);
}
