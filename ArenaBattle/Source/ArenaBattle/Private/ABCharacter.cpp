...
void AABCharacter::BeginPlay()
{
	...
	/*if (!IsPlayerControlled())
	{
		...
		ABLOG(Warning, TEXT("Character Asset %d"), RandIndex);

		auto ABGameInstance = Cast<UABGameInstance>(GetGameInstance());
		if (nullptr != ABGameInstance)
		{
			//AssetStreamingHandle = ABGameInstance->StreamableManager.RequestAsyncLoad(CharacterAssetToLoad, FStreamableDelegate::CreateUObject(this, &AABCharacter::OnAssetLoadCompleted));
			ABGameInstance->StreamableManager.RequestAsyncLoad(CharacterAssetToLoad, FStreamableDelegate::CreateUObject(this, &AABCharacter::OnAssetLoadCompleted));
...
void AABCharacter::OnAssetLoadCompleted()
{
	...
	TAssetPtr<USkeletalMesh> NewCharacter(CharacterAssetToLoad);
	if (NewCharacter)
	{
